        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="mt-6 text-lg text-gray-600 leading-relaxed max-w-xl">
              A Zyone Perfumes e Cosméticos é o caminho para quem quer começar com pouco e alcançar liberdade,
              autonomia e alto potencial de ganhos. Transforme sua renda com um modelo simples, lucrativo e pronto para crescer.
            </p>
            ...
            <div className="mt-10 flex flex-col sm:flex-row gap-4">
              ...
              <a 
                href="https://api.whatsapp.com/send?phone=5511964795145&text=Oi%2C+Nathan.+Vim+pelo+site+e+gostaria+de+informa%C3%A7%C3%B5es+de+como+cadastrar+e+revender+produtos+da+Zyone." 
            ...
            <div className="mt-12 bg-zyone-red p-6 rounded-2xl text-white relative overflow-hidden group">
