          ...
          >
            <div className="px-4 pt-2 pb-6 space-y-1">
              ...
              <div className="pt-4 space-y-2">
                <a href="https://api.whatsapp.com/send?phone=5511964795145&text=Oi%2C+Nathan.+Vim+pelo+site+e+gostaria+de+informa%C3%A7%C3%B5es+de+como+cadastrar+e+revender+produtos+da+Zyone." className="block w-full py-3 bg-green-500 text-white rounded font-bold text-sm text-center">WHATSAPP</a>
